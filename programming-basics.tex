...
When authoring a function or a code fragment, development is simplified if the new code added won't have unintended consequences elsewhere.
...
The most important scopes in C++ are the
\emph{global} namespace scope, accessible on the whole program;
